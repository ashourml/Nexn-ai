    ...
    <section className="bg-[#f0f0f0] text-black py-24 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
          <div>
            <AnimatedTextBlur text="Overview" className="text-sm uppercase tracking-widest text-gray-500" />
            <AnimatedTextBlur text="Breakthrough" className="text-sm uppercase tracking-widest text-gray-500" />
          </div>
          <div>
            <AnimatedTextBlur
