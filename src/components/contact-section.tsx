...
export const ContactSection = () => {
  ...
  return (
    <>
      <section
        id="contact"
        className="bg-[#f0f0f0] text-black py-24 sm:py-32"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              />
              <AnimatedTextBlur
                text="Driven by People"
                className="text-3xl md:text-4xl font-light tracking-tight mb-4"
              />
              <AnimatedTextBlur
                text="We believe technology is only as powerful as the people behind it. Discover the team that makes it possible."
            ...
            <div>
              ...
              />
              <AnimatedTextBlur
                text="Questions, ideas, or just a hello — we're here. Reach out and let's build something remarkable together."
                className="text-gray-600 mb-8"
              />
              <motion.button
                onClick={() => setIsModalOpen(true)}
