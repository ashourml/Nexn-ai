        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative text-center mb-32 h-96 flex items-center justify-center">
            ...
            >
              <Image 
                src="/ear.png" 
                alt="Innovative wearable technology device - next-generation AI hardware design" 
                width={320}
                height={320}
          ...
          <div className="grid md:grid-cols-[1fr_3fr] gap-16 items-end">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-start">
                ...
                {/* Subtle Technical Details CTA */}
                <motion.button
                  onClick={() => setIsModalOpen(true)}
                  className="inline-flex items-center justify-center rounded-full border border-white/40 bg-white/30 px-4 py-2 text-xs font-medium text-black backdrop-blur-md transition-colors hover:bg-white/40"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Technical Details
